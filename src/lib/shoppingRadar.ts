...
export function normalizeName(raw: string): string {
  ...
  // "tomato", "peaches" → "peach", "boxes" → "box". A blanket "-s" drop would
  // fold these to "tomatoe"/"peache", splitting their restock history from the
  // singular so neither bucket ever gathers enough to predict. (Mirrors
  // foldPlural in types/index.ts.)
